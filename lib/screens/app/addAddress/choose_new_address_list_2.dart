...
class ChooseNewAddress2 extends StatefulWidget {
  const ChooseNewAddress2({ Key? key }) : super(key: key);

  @override
  _ChooseNewAddress2State createState() => _ChooseNewAddress2State();
}

class _ChooseNewAddress2State extends State<ChooseNewAddress2> {
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child: Text(
                "Boşaltma noktalarını belirleyin.",
